          ...
          <>
            ...
            >
              <div className="mobile-nav__header">
                <button className="mobile-nav__close-btn" onClick={() => setIsOpen(false)} aria-label="Close menu">
                  <CloseIcon />
                </button>
              </div>
              <div className="mobile-nav__links" role="menu" aria-label="Mobile navigation">
  {LINKS.map((link) => {
    const isActive = active === link.id;
    return (
      <a
